	...
	if ($fn && $ln && $e && $p) { // If everything's OK...
		...
		if (mysqli_num_rows($r) == 0) { // Available.
			...
			if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
				...
				// Send the email:
				$body = "Thank you for registering at MUB. To activate your account, please click on this link:\n\n";
				$body .= BASE_URL . 'activate.php?x=' . urlencode($e) . "&y=$a";
				mail($trimmed['email'], 'Registration Confirmation', $body, 'From: philr@nait.ca');
